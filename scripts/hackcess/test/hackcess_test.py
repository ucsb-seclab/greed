...
def analyze_call_from_ep(entry_point, target_call_info):
    ...
    #entry_state.inspect.stop_at_stmt(stmt_name="CALLPRIVATE", func=bp)
    entry_state.inspect.stop_at_stmt_id(stmt_id="0x1960x15e0x600x45")
    entry_state.inspect.stop_at_stmt_id(stmt_id="0x1190x45")
