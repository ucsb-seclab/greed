...
class LambdaConstraint:
    ...
    def instantiate(self, index):
        return Array_Select(self.array, index)
...
class LambdaMemsetConstraint(LambdaConstraint):
    ...
    def instantiate(self, index):
        ...
        instance = If(index_in_range,
                      self.value,
                      self.parent.instantiate(index))
...
class LambdaMemory:
    ...
    def __init__(self, tag=None, value_sort=None, default=None, state=None, partial_init=False):
        ...
        self.lambda_constraint = LambdaConstraint(self._base)
    ...
    def __getitem__(self, index):
        ...
        self.read_count += 1        
        # instantiate lambda memory
        return self.lambda_constraint.instantiate(index)
